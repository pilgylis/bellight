...
public class FixtureContentTests(MongoDbFixture fixture) : IClassFixture<MongoDbFixture>
{
    ...
    public async Task DataExists()
    {
        ...
        await PrepareData(scope.ServiceProvider);
        var customerRepository = scope.ServiceProvider.GetRequiredService<IRepository<Customer, string>>();
        var productRepository = scope.ServiceProvider.GetRequiredService<IRepository<Product, string>>();
        var orderRepository = scope.ServiceProvider.GetRequiredService<IRepository<Order, string>>();
    ...
    private async Task PrepareData(IServiceProvider services)
    {
        ...
        await AddCustomers(services).ConfigureAwait(false);

        await AddProducts(services).ConfigureAwait(false);

        await AddOrders(services).ConfigureAwait(false);
    }

    private async Task AddCustomers(IServiceProvider services)
    {
        // import customer
    ...
    private async Task AddProducts(IServiceProvider services)
    {
    ...
    private async Task AddOrders(IServiceProvider services)
    {
        var customerRepository = services.GetRequiredService<IRepository<Customer, string>>();
        var productRepository = services.GetRequiredService<IRepository<Product, string>>();
        var orderRepository = services.GetRequiredService<IRepository<Order, string>>();
