...
public class MessageBusFactory(IServiceProvider serviceProvider, ILogger<MessageBusFactory> logger) : IMessageBusFactory
{
    ...
    private readonly ILogger<MessageBusFactory> logger = logger;
